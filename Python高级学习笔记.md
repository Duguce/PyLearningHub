...
- [Python高级学习笔记](#python高级学习笔记)
  - [1 正则表达式](#1-正则表达式)
    - [1.1 re模块简介](#11-re模块简介)
    - [1.2 匹配单个字符](#12-匹配单个字符)
    - [1.3 匹配多个字符](#13-匹配多个字符)
    - [1.4 匹配开头结尾](#14-匹配开头结尾)
    - [1.5 匹配分组](#15-匹配分组)
    - [1.6 贪婪与非贪婪匹配](#16-贪婪与非贪婪匹配)
  - [2 GIL](#2-gil)
  - [3 深浅拷贝](#3-深浅拷贝)
  - [4 import导入模块](#4-import导入模块)
    - [4.1 import搜索路径](#41-import搜索路径)
    - [4.2 重新导入模块](#42-重新导入模块)
  - [5 面向对象编程](#5-面向对象编程)
    - [5.1 工厂模式](#51-工厂模式)
    - [5.2 多继承](#52-多继承)
    - [5.3 实例方法、静态方法和类方法](#53-实例方法静态方法和类方法)
    - [5.4 property属性](#54-property属性)
    - [5.5 魔法属性](#55-魔法属性)
    - [5.6 上下文管理器](#56-上下文管理器)
  - [6 闭包与装饰器](#6-闭包与装饰器)
    - [6.1 闭包](#61-闭包)
    - [6.2 装饰器](#62-装饰器)
  - [7 元类\&抽象类\&接口类](#7-元类抽象类接口类)
    - [7.1 元类](#71-元类)
    - [7.2 抽象类](#72-抽象类)
    - [7.3 接口类](#73-接口类)
