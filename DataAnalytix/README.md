...
| 序号 |                       项目名称                       |                          数据集来源                          |
| :--: | :--------------------------------------------------: | :----------------------------------------------------------: |
|  1   |     [电商零售数据分析](./电商零售数据分析.ipynb)     | [E-Commerce Data（kaggle）](https://www.kaggle.com/datasets/carrie1/ecommerce-data) |
|  2   | [淘宝用户行为数据分析](./淘宝用户行为数据分析.ipynb) | [UserBehavior（TIANCHI）](https://tianchi.aliyun.com/dataset/649?spm=5176.12281976.J_3941670930.10.278012c4DsfWE6) |
